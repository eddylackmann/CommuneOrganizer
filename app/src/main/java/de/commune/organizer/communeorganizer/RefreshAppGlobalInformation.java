...
public class RefreshAppGlobalInformation extends AppCompatActivity implements AsyncResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.async_loading_layout);
            ...
            builder.setMessage("Der Admin hat sie aus der WG entfernt.")
                    .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            controller.finish();
                            Intent intent = new Intent(RefreshAppGlobalInformation.this, MainActivity.class);
