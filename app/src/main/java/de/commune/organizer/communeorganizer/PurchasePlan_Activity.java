...
public class PurchasePlan_Activity extends AppCompatActivity implements AsyncResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.purchase_plan_layout);
        controller = this;
    ...
    public void init(){
        ...
        Intent intent = new Intent(PurchasePlan_Activity.this, RefreshApp_Activity.class);
        ...
        switch (asyncTaskMethod){
            ...
            case "createPurchasePlanEntry":
                if (s.equals("entryCreated")){
                    finish();
                    intent = new Intent(PurchasePlan_Activity.this, PurchasePlan_Activity.class);
                    startActivity(intent);
                }
                else {
            ...
            case "addCash":
                if (s.equals("cashUpdated")){
                    finish();
                    intent = new Intent(PurchasePlan_Activity.this, Home_Activity.class);
                    startActivity(intent);
                }
                break;
        }
