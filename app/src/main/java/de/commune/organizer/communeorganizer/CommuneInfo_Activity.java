...
public class CommuneInfo_Activity extends AppCompatActivity implements AsyncResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.commune_info_layout);
    ...
    private void init() {
        ...
        Intent intent = new Intent(CommuneInfo_Activity.this, RefreshApp_Activity.class);
        ...
        switch (asyncTaskMethod) {
            case "updateCommune":
                switch (s) {
                    case "communeUpdated":
                        finish();
                        Intent intent = new Intent(CommuneInfo_Activity.this, Home_Activity.class);
                        startActivity(intent);
                        break;
                }
                break;
            case "deleteCommune":
                switch (s) {
                    case "communeDeleted":
                        finish();
                        Intent intent = new Intent(CommuneInfo_Activity.this, CreateJoinCommune_Activity.class);
                        startActivity(intent);
                        break;
                }
                break;
