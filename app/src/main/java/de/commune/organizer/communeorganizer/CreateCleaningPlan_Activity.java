...
public class CreateCleaningPlan_Activity extends AppCompatActivity implements AsyncResponse, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.create_cleaning_plan_layout);
        controller = this;
    ...
    public void init() {
        ...
        Intent intent = new Intent(CreateCleaningPlan_Activity.this, RefreshApp_Activity.class);
        startActivity(intent);

        Time today = new Time(Time.getCurrentTimezone());
        today.setToNow();
        final DatePickerDialog datePickerDialog = new DatePickerDialog(this, android.app.AlertDialog.THEME_DEVICE_DEFAULT_LIGHT, CreateCleaningPlan_Activity.this, today.year, today.month, today.monthDay);
        ...
        switch (asyncTaskMethod) {
            case "createCleaningTask":
                ...
                if (s.equals("entryCreated")) {
                    finish();
                    Intent intent = new Intent(CreateCleaningPlan_Activity.this, CleaningPlan_Activity.class);
                    startActivity(intent);
                }
