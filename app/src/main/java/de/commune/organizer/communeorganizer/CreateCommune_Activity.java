...
public class CreateCommune_Activity extends AppCompatActivity implements AsyncResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.create_commune_layout);
        init();
    }
    ...
    public void processFinish(String s) {
        switch (s) {
            case "communeCreationSuccessful":
                Intent intent = new Intent(CreateCommune_Activity.this, Home_Activity.class);
