...
public class InhabitantList_Activity extends AppCompatActivity implements AsyncResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inhabitant_list_layout);
        controller = this;
    ...
    public void init() {
        ...
        Intent intent = new Intent(InhabitantList_Activity.this, RefreshApp_Activity.class);
        ...
        switch (asyncTaskMethod) {
            ...
            case "exitCommune":
                if (s.equals("exitSuccessful")) {
                    finish();
                    Intent intent = new Intent(InhabitantList_Activity.this, Home_Activity.class);
                    startActivity(intent);
