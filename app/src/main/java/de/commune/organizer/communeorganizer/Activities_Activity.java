...
public class Activities_Activity extends AppCompatActivity implements AsyncResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activties_layout);
        controller = this;
    ...
    public void init() {
        ...
        Intent intent = new Intent(Activities_Activity.this, RefreshApp_Activity.class);
        ...
        activities_AddBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent intent = new Intent(Activities_Activity.this, CreateActivities_Activity.class);
                startActivity(intent);
            }
        });
    }
        ...
        switch (asyncTaskMethod) {
            ...
            case "deleteActivityEntry":
                if (s.equals("entryDeleted")) {
                    finish();
                    intent = new Intent(Activities_Activity.this, Activities_Activity.class);
                    startActivity(intent);
